...
- 4: PC のエクスプローラーのアドレス欄に `shell:startup` と入力し表示されたフォルダ内に [Discord Typing Sites RPC.exe](https://github.com/Toshi7878/Discord-Typing-Sites-RPC/raw/main/Discord%20Typing%20Sites%20RPC.exe) をダウンロードしファイルをコピーします。
...
- 1: [Discord Typing Sites RPC Jar.zip](https://github.com/Toshi7878/Discord-Typing-Sites-RPC/raw/main/Discord%20Typing%20Sites%20RPC%20Jar.zip)をダウンロードします。<br>
